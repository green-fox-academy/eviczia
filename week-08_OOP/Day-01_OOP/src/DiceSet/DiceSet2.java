...
public class DiceSet2 {
    ...
    public int sumDice(DiceSet2 diceSet) {
        int sum = 0;
        for (int die:diceSet.getCurrent()) {
            sum += die;
        } return sum;
    }
    ...
    public static void main(String[] args) {
        ...
        DiceSet2 diceSet = new DiceSet2();
        diceSet.roll();
        int counter = 0;
        while (diceSet.sumDice(diceSet) < 36) {
 ...
 /*       System.out.println(diceSet.getCurrent());
        ...
        diceSet.reroll(4);
        System.out.println(diceSet.getCurrent());
        System.out.println(diceSet.sumDice(diceSet));*/
    }
}